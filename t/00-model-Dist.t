...
my $o = CPAN::Portal::Model::Dist->new(current_user => $system_user);
my ($id) = $o->create();
...
# Searches in general
my $collection =  CPAN::Portal::Model::DistCollection->new(current_user => $system_user);
$collection->unlimit;
