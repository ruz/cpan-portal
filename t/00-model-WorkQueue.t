...
use_ok('CpanPortal::Model::WorkQueue');
...
my $o = CpanPortal::Model::WorkQueue->new(current_user => $system_user);
my ($id) = $o->create();
...
# Searches in general
my $collection =  CpanPortal::Model::WorkQueueCollection->new(current_user => $system_user);
$collection->unlimit;
