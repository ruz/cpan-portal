...
use_ok('CpanPortal::Model::Author');
...
my $o = CpanPortal::Model::Author->new(current_user => $system_user);
my ($id) = $o->create();
...
# Searches in general
my $collection =  CpanPortal::Model::AuthorCollection->new(current_user => $system_user);
$collection->unlimit;
